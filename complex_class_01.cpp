/*
In this code only change is of keyword from struct to class
Subsequently we need to use public: to get the code compiled
Here we learn the concept of private and protected data
*/
