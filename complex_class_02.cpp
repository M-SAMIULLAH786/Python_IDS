/*
In this code we learn the concept of accessor and mutators,
also known as, getters and setters. These are public 
functions to provide access to private and protected data.
*/
